...
public class APISettingsViewModel: ObservableObject {
    ...
    private func installCLIConnectionObservers() {
        ...
        // OMP is the only ACP provider whose discovered catalog also feeds the non-agent
        ...
        NotificationCenter.default.publisher(for: .acpDiscoveredModelsChanged)
            ...
            .sink { [weak self] notification in
                ...
                guard changedProviderID == nil || changedProviderID == ACPProviderID.omp.rawValue else {
                    return
                }
