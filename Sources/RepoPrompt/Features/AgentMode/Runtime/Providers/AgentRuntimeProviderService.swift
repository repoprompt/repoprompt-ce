...
enum AgentProviderKind: String, CaseIterable, Hashable {
    ...
    var agentDescription: String {
        ...
        case .grokBuild:
            return "Grok Build CLI ACP agent. Uses the official `grok agent stdio` runtime, injects RepoPrompt MCP tools through ACP session configuration, and selects its model at launch (`grok-build` or `grok-composer-2.5-fast`)."
        case .claudeCodeGLM:
