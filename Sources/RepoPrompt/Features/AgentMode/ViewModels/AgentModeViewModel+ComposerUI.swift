...
extension AgentModeViewModel {
    func makeComposerProps(tabID explicitTabID: UUID? = nil) -> AgentComposerProps {
        ...
        return AgentComposerProps(
            ...
            hasAvailableAgentProviders: hasAvailableAgentProviders || session?.isSwitchboardManagedSession == true,
            canSendWithCurrentProvider: canSendWithProvider(selectedAgent, session: session),
            ...
            availableAgents: session?.isSwitchboardManagedSession == true ? [.codexExec] : availableAgents,
