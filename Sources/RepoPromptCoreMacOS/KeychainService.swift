...
package final class KeychainService: SecureKeyValueStorageBackend, @unchecked Sendable {
    package typealias KeychainError = SecureStorageError
    ...
    package static func legacyRepairSource(
    ...
    private func query(
        ...
        guard accessMode.isNonInteractive else { return values }
        var query = values
    ...
    private func keychainError(for status: OSStatus) -> SecureStorageError {
        ...
        case errSecUserCanceled: .userInteractionCancelled
