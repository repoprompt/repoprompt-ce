...
private struct ContentReadRequest {
    ...
    let fileContentSnapshotReader: any FileContentSnapshotReading
    #if DEBUG
...
package actor ContentReadAsyncLimiter {
        ...
        package struct Snapshot: Equatable {
            ...
            /// Compatibility aliases for existing idle-state assertions.
            var queueDepth: Int {
                queuedWaiterCount
            }
    ...
    private struct WaiterState {
        ...
        let diagnosticsSink: (any WorkspaceRuntimeDiagnosticsSink)?
    ...
    func withPermit<T>(
        ...
        let diagnosticsSink = WorkspaceRuntimePerf.currentSink
    ...
    private func acquire(
        ...
        diagnosticsSink: (any WorkspaceRuntimeDiagnosticsSink)?
...
extension FileSystemService {
    ...
    private func makeContentReadRequest(
        ...
        guard absolutePath != standardizedRootPath,
            ...
            return ContentReadRequest(
                ...
                fileContentSnapshotReader: fileContentSnapshotReader,
    ...
    private func commitContentReadResultIfCurrent(_ result: ContentReadResult, cacheKey: String) {
        ...
        guard (try? fileContentSnapshotReader.fingerprint(atPath: result.absolutePath)) == fingerprint else { return }
    ...
    private nonisolated static func readContentFromDisk(
        ...
        do {
            ...
            if requirePostReadValidation {
                let postReadFingerprint = try request.fileContentSnapshotReader.fingerprint(atPath: request.absolutePath)
    ...
    private nonisolated static func validateContentFileForReading(_ request: ContentReadRequest) throws -> ValidatedContentFile {
        ...
        return ValidatedContentFile(
            ...
            fileContentSnapshotReader: request.fileContentSnapshotReader
        )
    }
    ...
    private nonisolated static func openValidatedContentHandle(
        ...
        let handle = try request.fileContentSnapshotReader.openReadOnlyFileHandle(atPath: request.absolutePath)
        do {
            if requireStableIdentity {
                guard try validated.fileContentSnapshotReader.fingerprint(fileDescriptor: handle.fileDescriptor) == validated.fingerprint else {
                    throw FileContentValidationError.fingerprintChanged
                }
            }
            return handle
