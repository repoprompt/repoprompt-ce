import Foundation
    ...
    extension FileSystemService {
        ...
        package func watcherIngressMailboxSnapshotForTesting() -> FileSystemWatcherIngressMailbox.Snapshot {
        ...
        package func publicationStateForTesting() -> (
        ...
        package func setWatcherActivationFailureForTesting(_ failurePoint: WatcherActivationFailurePoint?) {
        ...
        package func setCachedSearchContentWatcherActiveOverrideForTesting(_ isActive: Bool?) {
        ...
        package func cachedEncodingForTesting(relativePath: String) -> String.Encoding? {
