...
package final class FileSystemWatcherIngressMailbox: @unchecked Sendable {
    ...
    struct AcceptedPayload: @unchecked Sendable {
        ...
        package struct Snapshot: Equatable {
            package let acceptedHighWatermark: Watermark
            package let queuedPayloadCount: Int
            package let queuedRawEntryCount: Int
            package let hasOverflowRootRescan: Bool
        }
    #endif
