...
package enum TypeCleaner {
    package struct TypeCleanerCacheKey: Hashable {
    ...
    package static func extractBaseTypes(from rawType: String, language: LanguageType) -> [String] {
        switch language {
        case .ts, .tsx:
    ...
    package static func extractBaseTypes(
        from rawType: String,
    ...
    package static func extractBaseTypesNonTS(_ rawType: String, language: LanguageType) -> [String] {
    ...
    package static func extractBaseTypesTS(_ rawType: String, language: LanguageType) -> [String] {
    ...
    package static func filterOutPrimitiveAndSpecialTypes(_ extracted: [String], language: LanguageType) -> [String] {
        var results: [String] = []
    ...
    package static func isGenericPlaceholderTypeName(_ typeName: String, language: LanguageType) -> Bool {
    ...
    package static func isSwiftSpecialTypeName(_ typeName: String) -> Bool {
        isSwiftSpecialType(typeName)
    }

    package static func isPrimitiveType(_ typeName: String, language: LanguageType) -> Bool {
    ...
    package static func isContainerType(_ typeName: String, language: LanguageType) -> Bool {
        let lower = typeName.lowercased()
