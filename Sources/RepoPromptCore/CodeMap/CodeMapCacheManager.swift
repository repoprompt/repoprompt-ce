...
package struct CodeMapContentFingerprint: Codable, Equatable {
    package let contentHash: String
    package let byteCount: Int

    package init(contentHash: String, byteCount: Int) {
...
package struct CodeMapCacheFileEntry: Codable {
    package let modificationDate: Date
    package let contentFingerprint: CodeMapContentFingerprint?
...
package struct CodeMapCacheRootFolder: Codable {
    package var files: [String: CodeMapCacheFileEntry]
}

/// Container to wrap the cache data with a version number.
package struct CodeMapCacheContainer: Codable {
    /// Version of the cached data format.
    package let version: Int
    /// The actual cache data.
    package let rootFolder: CodeMapCacheRootFolder
}

// ============ The Manager ============

package final class CodeMapCacheManager {
    ...
    package func loadRootFolderCacheAsync(rootFolderPath: String) async -> CodeMapCacheRootFolder? {
    ...
    package func loadCachedCodeMap(
        rootFolderPath: String,
        relativeFilePath: String,
        currentFullPath: String,
        currentModDate: Date,
    ...
    package func removeRootFolder(_ rootFolderPath: String) {
    ...
    package func overwriteRootFolderEntry(rootPath: String, newFilesDict: [String: CodeMapCacheFileEntry]) {
    ...
    package func fetchRootFolderEntry(_ rootFolderPath: String) -> CodeMapCacheRootFolder? {
    ...
    package func unloadCache(forRootFolder rootFolderPath: String) {
        cache.removeValue(forKey: rootFolderPath)
        dirtyRootFolders.remove(rootFolderPath)
    }
    ...
    @discardableResult
    package func saveRootFolderCache(_ rootFolderPath: String, rootEntry: CodeMapCacheRootFolder) -> Bool {
