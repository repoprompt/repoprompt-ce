...
package enum TypeScriptCodeMapStrategy {
    ...
    package static func buildContext(
    ...
    package static func useRangeContainment(_ context: Context) -> Bool {
    ...
    package static func handleCapture(
        _ cap: NamedRange,
        context: Context,
        index: CodeMapCaptureIndex,
        content: String,
