...
package struct CodeMapExtractionMemo {
    ...
    package mutating func matchFunctionLine(
        _ line: String,
    ...
    package mutating func matchFunctionLineParsed(
        _ line: String,
        language: LanguageType,
        stats: CodeMapPerfStats?
    ...
    package mutating func matchVariableLine(
        _ line: String,
        language: LanguageType,
        stats: CodeMapPerfStats?
    ) -> [String: String]? {
    ...
    package mutating func tsReturnType(
    ...
    package mutating func tsTypeAnnotation(from line: String, stats: CodeMapPerfStats?) -> String? {
    ...
    package mutating func tsTypeAliasRHS(from line: String, stats: CodeMapPerfStats?) -> String? {
