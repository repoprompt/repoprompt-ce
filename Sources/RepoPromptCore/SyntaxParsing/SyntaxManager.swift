...
package final class SyntaxManager {
    ...
    package let optimizedQueries: [LanguageType: String] = [
        .swift: swiftQuery,
        .js: javascriptQuery,
        .c_sharp: csharpQuery,
        .python: pythonQuery,
    ...
    package let codeMapQueries: [LanguageType: String] = [
        .c: cCodeMapQuery,
        .cpp: cppCodeMapQuery,
    ...
    package func languageConfig(forFileExtension ext: String) -> LanguageConfiguration? {
        withTreeSitterExecution {
    ...
    package func parse(content: String, fileExtension: String) throws -> MutableTree? {
