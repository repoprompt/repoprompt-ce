...
package enum WorkspaceFileContextCaptureCoverage: Equatable {
    package enum CodemapCoverage: Equatable {
        case referenced
        case allAvailable
    }

    case complete
    case projection(codemapCoverage: CodemapCoverage)
}
...
package struct WorkspaceFileContextCapture {
    ...
    package let coverage: WorkspaceFileContextCaptureCoverage
    ...
    package init(
        coverage: WorkspaceFileContextCaptureCoverage = .complete,
        provenance: Provenance,
        storedSelection: StoredSelection,
        selectedPaths: [SelectionPath],
        autoCodemapPaths: [SelectionPath],
        slices: [Slice],
        catalog: WorkspaceSearchCatalogSnapshot,
        materializedFolders: [WorkspaceFolderRecord],
        materializedFiles: [WorkspaceFileRecord],
        ...
        self.materializedFolders = materializedFolders
        self.materializedFiles = materializedFiles
        self.codemapSnapshots = codemapSnapshots
