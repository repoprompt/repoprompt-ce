//
//  PromptTokenAccountingService.swift
//  RepoPrompt
//
...
package struct TokenCalculationResult {
    ...
    package init(
        totalTokenCount: Int,
        totalTokenCountFilesOnly: Int,
        fileTokenInfo: [UUID: TokenInfo],
        folderTokenInfo: [String: TokenInfo],
        tokenCountString: String,
        tokenCountFilesOnlyString: String,
        charCount: Int,
        fileTreeContent: String,
        fileTreeTokenCount: Double,
        fileTreeTokenCountRaw: Int,
        codeMapContent: String,
        codeMapFileCount: Int,
        codeMapTokenCount: Int
    ) {
        self.totalTokenCount = totalTokenCount
        self.totalTokenCountFilesOnly = totalTokenCountFilesOnly
        self.fileTokenInfo = fileTokenInfo
        self.folderTokenInfo = folderTokenInfo
        self.tokenCountString = tokenCountString
        self.tokenCountFilesOnlyString = tokenCountFilesOnlyString
        self.charCount = charCount
        self.fileTreeContent = fileTreeContent
        self.fileTreeTokenCount = fileTreeTokenCount
        self.fileTreeTokenCountRaw = fileTreeTokenCountRaw
...
package struct TokenComponentBreakdown {
    ...
    package init(prompt: Int, duplicatePrompt: Int, instructions: Int, fileTree: Int, gitDiff: Int, metadata: Int) {
        self.prompt = prompt
...
package struct PromptEntriesEvaluation {
    ...
    package struct EntryResult {
        ...
        package init(fileID: UUID, renderMode: RenderMode, displayTokens: Int, fullTokens: Int, codemapTokens: Int) {
            self.fileID = fileID
...
package actor TokenCalculationService {
    ...
    package static func estimateTokens(for text: String) -> Int {
        TokenEstimator.estimateTokens(for: text)
    }
    ...
    package func calculatePromptStats(
        ...
        currentCalculationTask = Task.detached {
            ...
            case let .snapshot(treeSnapshot):
                CodeMapSnapshotRenderer.generateFileTree(using: treeSnapshot)
            }
