...
package struct WorkspaceSearchContentCacheKey: Hashable {
    package let rootID: UUID
    let fileID: UUID
    let standardizedRelativePath: String

    package init(rootID: UUID, fileID: UUID, standardizedRelativePath: String) {
        self.rootID = rootID
        self.fileID = fileID
...
package struct WorkspaceSearchContentInvalidationBatch {
...
package struct WorkspaceSearchDecodedContentEntry {
    let content: String?
...
package actor WorkspaceSearchDecodedContentCache {
    #if DEBUG
        package struct Snapshot: Equatable {
            ...
            package let acceptedLoadCount: Int
            package let latestRevision: UInt64
        }
    #endif
    ...
    package init(maxEntryCount: Int = 4096, maxEstimatedCost: Int = 128 * 1024 * 1024) {
