...
package struct OrderedSearchBatchWindow {
    ...
    package var enqueueLead: Int {
        nextBatchToEnqueue - nextBatchToDrain
    }

    package mutating func takeNextBatchToEnqueue() -> Int? {
    ...
    package mutating func advanceDrainFrontier() {
...
package actor FileSearchActor {
    ...
    package static func contentScanBatchSize(fileCount: Int, workerCount: Int) -> Int {
    ...
    private static func lineIndexCacheIdentity(
        ...
        return WorkspaceRuntimePerf.measure(
            ...
            .hashed(filePath: file.fullPath, utf16Length: utf16Length, hash: StringLineUtilities.fnv1a64(content))
        }
    }
