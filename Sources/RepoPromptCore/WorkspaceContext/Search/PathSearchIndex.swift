...
package final class PathSearchIndex: @unchecked Sendable {
    package struct Candidate: Equatable {
        package let index: Int
        package let path: String
        package let filename: String
        package let score: Int32
        package let tieBreakKey: String
    }
    ...
    package static func build(paths: [String]) async -> PathSearchIndex {
    ...
    package func searchSynchronously(_ pattern: String, limit: Int = 300) -> [Candidate] {
...
package func path_search_create(_ paths: UnsafePointer<UnsafePointer<CChar>?>?, _ count: Int) -> OpaquePointer?

@_silgen_name("path_search_destroy")
package func path_search_destroy(_ index: OpaquePointer?)

@_silgen_name("path_search_find")
package func path_search_find(_ index: OpaquePointer?, _ pattern: UnsafePointer<CChar>?, _ limit: Int) -> OpaquePointer?

@_silgen_name("search_result_destroy")
package func search_result_destroy(_ result: OpaquePointer?)

package struct search_result_t {
...
package struct WorkspaceSearchRootPathIndexIdentity: Equatable, Hashable {
...
package final class WorkspaceSearchRootPathIndex: @unchecked Sendable {
    enum BuildKind {
        case full
        case overlay
        case reused
