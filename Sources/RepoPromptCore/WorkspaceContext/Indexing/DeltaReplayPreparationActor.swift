...
package enum WorkspaceReplayDiagnostics {
    package struct State {}

    package static func begin(_: StaticString) -> State? {
        nil
    }

    package static func end(_: StaticString, _: State?) {}
}
...
package struct PreparedFileSystemDelta {
    ...
    package var isFolderAdded: Bool {
        if case .folderAdded = delta { return true }
        return false
    }

    package var isFolderRemoved: Bool {
...
package struct PreparedFileSystemReplayChunkSummary: Equatable {
    ...
    package var fileModifiedCount: Int = 0
    package var folderModifiedCount: Int = 0
...
package enum FileSystemDeltaPreparation {
    ...
    package static func makeChunkRanges(totalCount: Int, chunkSize: Int) -> [Range<Int>] {
    ...
    package static func prepareBatch(
        rootKey: String,
...
package actor DeltaReplayPreparationActor: DeltaReplayPreparing {
    ...
    package func prepare(
        ...
        let signpost = WorkspaceReplayDiagnostics.begin("prepareReplayBatch")
        defer { WorkspaceReplayDiagnostics.end("prepareReplayBatch", signpost) }
