...
package enum PathMatcher {
    ...
    package static let isLoggingEnabled = false
    ...
    package static let absoluteSuffixFallbackEnabled = true
    package static let absSuffixMinComponents = 2
    package static let absSuffixMaxComponents = 20
    ...
    package static func findCreationPath(
        userPath: String,
        snapshot: PathMatchSnapshot
    ) -> FileCreationResult? {
        if isLoggingEnabled {
    ...
    package static func resolveCreationPath(
        userPath: String,
        snapshot: PathMatchSnapshot,
    ...
    package static func absolutePathCandidates(forRelativePath relPath: String, snapshot: PathMatchSnapshot) -> [String] {
