...
package struct SelectionSig: Equatable {
    package let count: Int
    package let hash: UInt64

    package static let empty = SelectionSig(count: 0, hash: 0)
}
...
package func selectionSignature(for paths: Set<String>) -> SelectionSig {
...
package actor PathMatchWorker {
    ...
    @discardableResult
    package func prepare(staticData: StaticPathMatchData) -> UInt64 {
