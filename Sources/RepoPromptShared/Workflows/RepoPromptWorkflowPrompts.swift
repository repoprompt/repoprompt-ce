...
public enum RepoPromptWorkflowPrompts {
    ...
    /// Version 63: Adds shared cost-aware agent lifecycle guardrails: validate bindings and paid-call artifacts before dispatch, never replay indeterminate committed mutations, recover expired handles through persisted session state, and stop identical cleanup/admission retry loops.
    public static let skillsVersion = 63
