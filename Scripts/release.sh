...
run_preflight() {
    ...
    require_file "$CONTROL_PLANE_SCRIPTS_DIR/package_headless.sh"
    require_file "$CONTROL_PLANE_SCRIPTS_DIR/install_headless_cli.sh"
    require_file "$CONTROL_PLANE_SCRIPTS_DIR/smoke_headless_mcp.sh"
