...
- Pinned release: https://github.com/openai/codex/releases/tag/rust-v0.153.4
- License at the pinned tag: https://github.com/openai/codex/blob/rust-v0.153.4/LICENSE
- Notice at the pinned tag: https://github.com/openai/codex/blob/rust-v0.153.4/NOTICE
...
For the 0.153.4 rotation, the pinned upstream `LICENSE` and `NOTICE` are
byte-identical to the prior 0.149.0 copies. The verified candidate manifest also
retains the Zsh 5.9 path and unchanged normalized Zsh payload, so no legal text
