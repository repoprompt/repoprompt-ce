...
import XCTest
    ...
    final class OracleGroupBoundaryTests: XCTestCase {
        ...
        private func makeOracleSendFixture() -> OracleSendBoundaryFixture {
            ...
            let service = MCPOracleToolService(
                ...
                requireCurrentTabContext: { _ in throw OracleBoundaryTestStop.afterRoute },
                ...
                sendChat: { _, _, _ in throw OracleBoundaryTestStop.unexpectedSend },
                exportOracleResponse: { _ in throw OracleBoundaryTestStop.unexpectedExport }
            )
            return OracleSendBoundaryFixture(window: window, service: service, rebindRecorder: recorder)
        }
    }
