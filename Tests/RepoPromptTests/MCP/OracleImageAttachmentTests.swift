...
final class OracleImageAttachmentTests: XCTestCase {
    ...
    @MainActor
    func testToolDocumentationIsProviderNeutralAndMatchesLimits() {
        let documentation = [
            MCPOracleToolProvider.oracleImageUsageDescription,
            MCPOracleToolProvider.oracleImagesArgumentDescription
        ].joined(separator: " ")
    ...
    func testAdmissionAllowsImageCapableTransportsAndRejectsCLIOnes() {
