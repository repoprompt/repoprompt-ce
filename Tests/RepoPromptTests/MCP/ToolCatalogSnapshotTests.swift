...
final class ToolCatalogSnapshotTests: XCTestCase {
    ...
    func testWorktreePublicAPISchemaFieldsRemainAdvertised() async throws {
        ...
        XCTAssertTrue(manageOpEnum.contains("retire"))
    ...
    private static let expectedSignatures: [String] = [
        ...
        "14|manage_worktree|enabled=true|ann=title=nil,readOnly=false,destructive=true,idempotent=nil,openWorld=false|desc=021e6bce47c851c98e923cc03a1b5cee4b24590686834a6beffe214863319163|schema=1e1b9981dd4f1981a3481fa051e5c863ddda0178fc1228f8619257485be2022f",
