...
/// Desktop `MCPClientIdentity`: family-aware MCP client matching used by
/// workspace Always Allow (`clientPolicies`) and related allow-lists.
public enum MCPClientIdentity {
    ...
    public static func canonicalFamilyID(_ raw: String?) -> String? {
    ...
    public static func storageKey(_ raw: String?) -> String? {
        canonicalFamilyID(raw) ?? normalized(raw)
    }

    public static func sameFamily(_ lhs: String?, _ rhs: String?) -> Bool {
    ...
    public static func isHeadlessAgentClient(_ raw: String?) -> Bool {
