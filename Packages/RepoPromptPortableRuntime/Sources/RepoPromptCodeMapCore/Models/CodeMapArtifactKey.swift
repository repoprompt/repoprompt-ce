...
public enum CodeMapCanonicalIdentityError: Error, Equatable, Sendable {
    case inputTooLarge
...
public struct CodeMapSHA256Digest: Hashable, Sendable {
...
public struct CodeMapSemanticVersion: Hashable, Sendable {
...
public enum CodeMapPipelineLanguageID: String, CaseIterable, Hashable, Sendable {
    case swift
    case javascript
    case cSharp = "c-sharp"
    case python
...
public struct CodeMapPipelineNamedLimit: Hashable, Sendable {
...
public struct CodeMapPipelineNamedFlag: Hashable, Sendable {
    public let name: String
...
public struct CodeMapPipelineIdentity: Hashable, Sendable {
    public static let domain = "codemap-pipeline-identity-v1"

    public static let requiredLimitNames = [
    ...
    public static let requiredFlagNames = [
    ...
    public let languageID: CodeMapPipelineLanguageID
    ...
    public let codeMapQuerySHA256: CodeMapSHA256Digest
    public let extractorVersion: CodeMapSemanticVersion
    public let generatorVersion: CodeMapSemanticVersion
    public let artifactSchemaVersion: UInt32
    public let oversizeParsePolicyVersion: UInt32
    public let limits: [CodeMapPipelineNamedLimit]
    public let flags: [CodeMapPipelineNamedFlag]
...
public struct CodeMapArtifactKey: Hashable, Sendable {
    public static let domain = "codemap-artifact-key-v1"

    private static let maximumCanonicalByteCount = 32 * 1024

    public let rawSHA256: CodeMapRawSourceDigest
    public let rawByteCount: UInt64
    public let pipelineIdentity: CodeMapPipelineIdentity
    ...
    public var storageDigest: CodeMapSHA256Digest {
        try! CodeMapSHA256Digest(bytes: Data(SHA256.hash(data: canonicalBytes)))
    }

    public var storageDigestHex: String {
