...
public struct InterfaceInfo: Codable, Equatable, Sendable {
    public let name: String
    public var properties: [PropertyInfo]
    public var methods: [FunctionInfo]

    public init(name: String, properties: [PropertyInfo] = [], methods: [FunctionInfo] = []) {
        self.name = name
...
public struct TypeAliasInfo: Codable, Equatable, Sendable {
    public let name: String
...
public struct ClassInfo: Codable, Equatable, Sendable {
    public let name: String
    public var methods: [FunctionInfo]
    public var properties: [PropertyInfo]

    public init(name: String, methods: [FunctionInfo], properties: [PropertyInfo]) {
        self.name = name
        self.methods = methods
        self.properties = properties
    }
...
public struct FunctionInfo: Codable, Equatable, Sendable {
    public let name: String
...
public struct ParameterInfo: Codable, Equatable, Sendable {
...
public struct VariableInfo: Codable, Equatable, Sendable {
    public let name: String
    public let typeName: String?
    public let definitionLine: String
...
public struct EnumInfo: Codable, Equatable, Sendable {
    public let name: String
...
public struct CodeMapAPIContentSummary: Sendable {
    public let apiDescription: String
    public let definedTypeNames: Set<String>
}

public enum CodeMapAPIContentFormatter {
...
public enum CodeMapSyntaxOversizeReason: Codable, Equatable, Sendable {
...
public enum CodeMapSyntaxParseFailure: String, Codable, Equatable, Sendable {
    case parserReturnedNilTree
    case parserReturnedNilRoot
}

public enum CodeMapSyntaxArtifactOutcome: Codable, Equatable, Sendable {
