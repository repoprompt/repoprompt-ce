...
public enum LanguageType: String, CaseIterable, Comparable, Codable, Sendable {
...
public enum CodeMapSyntaxQueryOutcome: Sendable {
    case captures([NamedRange])
    case oversize(CodeMapSyntaxOversizeReason)
    case parseFailed(CodeMapSyntaxParseFailure)
}

public struct CodeMapLanguagePipelineDescriptor: Sendable {
    public let stableLanguageID: CodeMapPipelineLanguageID
    public let grammarRevision: String
    public let treeSitterABIVersion: UInt32
    public let queryBytes: Data
}

public struct CodeMapGrammarDescriptor: Sendable {
...
public enum CodeMapSyntaxEngineError: Error, Equatable, Sendable {
...
public protocol CodeMapSyntaxQuerying {
    func codeMap(content: String, language: LanguageType) throws -> CodeMapSyntaxQueryOutcome
}

public protocol CodeMapSyntaxPerformanceQuerying: CodeMapSyntaxQuerying {
    func codeMap(
        content: String,
...
public struct CodeMapSyntaxEngine: CodeMapSyntaxPerformanceQuerying, Sendable {
    public static let shared = CodeMapSyntaxEngine()

    public static let parseLineLimit = 25_000
    public static let parseUTF16Limit = 1_500_000
    public static let parseUTF8Limit = 5_000_000

    public static let extensionToLanguage: [String: LanguageType] = [
        "swift": .swift,
        "js": .js,
        "cs": .c_sharp,
        "py": .python,
    ...
    public func language(forFileExtension fileExtension: String) -> LanguageType? {
    ...
    public static func supportsCodeMap(fileExtension: String) -> Bool {
        extensionToLanguage[fileExtension.lowercased()] != nil
    }

    public static func isLightweight(language: LanguageType) -> Bool {
        switch language {
    ...
    public func grammarDescriptor(for languageType: LanguageType) throws -> CodeMapGrammarDescriptor {
        try RegisteredLanguageStore.lookup(for: languageType)
    }

    public func codeMapPipelineDescriptor(
    ...
    public func oversizeReason(for content: String) -> CodeMapSyntaxOversizeReason? {
    ...
    public func codeMap(content: String, language: LanguageType) throws -> CodeMapSyntaxQueryOutcome {
    ...
    public static func exceededLineCount(in utf8: String.UTF8View, limit: Int) -> Int? {
