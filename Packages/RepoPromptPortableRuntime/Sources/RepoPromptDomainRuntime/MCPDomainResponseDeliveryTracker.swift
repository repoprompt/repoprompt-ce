...
public struct MCPDomainResponseDeliverySnapshot: Equatable, Sendable {
    ...
    public var acceptedRequestsFullyResponded: Bool {
...
public final class MCPDomainResponseDeliveryTracker: @unchecked Sendable {
    ...
    public func recordAcceptedClientFrame(_ frame: Data) {
    ...
    public func waitUntilDrained() async -> Bool {
    ...
    public func snapshot() -> MCPDomainResponseDeliverySnapshot {
        lock.lock()
        defer { lock.unlock() }
