...
public enum DomainSettingValue: Codable, Equatable, Sendable {
    case bool(Bool)
    case integer(Int)
    case number(Double)
    case string(String)
...
public enum DomainSettingValueKind: String, Codable, Sendable {
    case boolean
    case integer
    case number
    case string
...
public struct DomainSettingDescriptor: Codable, Equatable, Sendable {
    public let key: String
    public let group: String
    public let valueKind: DomainSettingValueKind
    public let defaultValue: DomainSettingValue
    public let description: String
    public let allowedValues: [DomainSettingValue]?
    public let optionsAvailable: Bool
...
public enum DomainAppSettingsCatalog {
    ...
    public static func descriptor(for key: String) -> DomainSettingDescriptor? { byKey[key] }

    public static func descriptors(in group: String?) throws -> [DomainSettingDescriptor] {
    ...
    public static func validate(_ value: DomainSettingValue, for descriptor: DomainSettingDescriptor) throws {
        if case .null = value {
...
public enum DomainDirectSettingsError: Error, LocalizedError, Equatable, Sendable {
...
public actor DomainDirectSettingsStore {
    ...
    public init(persistence: DomainPersistenceCoordinator, profileIdentifier: String) {
    ...
    public func effectiveValue(for key: String) throws -> DomainSettingValue {
    ...
    public func effectiveValues(for descriptors: [DomainSettingDescriptor]) -> [String: DomainSettingValue] {
        Dictionary(uniqueKeysWithValues: descriptors.map { ($0.key, values[$0.key] ?? $0.defaultValue) })
    }

    public func set(key: String, value: DomainSettingValue) async throws -> UInt64 {
