...
public enum DomainInteractionProviderKind: String, Sendable {
    case elicitation
    case appUI = "app_ui"
}

public struct DomainInteractionRequest: Hashable, Sendable {
    public let id: UUID
...
public struct DomainInteractionProvider: Sendable {
    public let kind: DomainInteractionProviderKind
    public let isAvailable: @Sendable (DomainInteractionRequest) async -> Bool
    public let present: @Sendable (DomainInteractionRequest) async throws -> Value
...
public enum DomainInteractionResult: Equatable, Sendable {
...
public struct DomainInteractionBrokerSnapshot: Sendable {
    public let generation: UInt64
    public let pendingRequestIDs: [UUID]
    public let ignoredLateResponseCount: UInt64
}

public actor DomainInteractionBroker {
    ...
    public func installNegotiatedElicitationProvider(
    ...
    public func cancel(clientID: UUID) async {
    ...
    public func snapshot() -> DomainInteractionBrokerSnapshot {
