...
public enum MCPToolExecutionSettlement: String, Equatable, Sendable {
    case success
    case cancellation
    case error
}

public enum MCPToolExecutionCancellationOrigin: String, Equatable, Sendable {
    case watchdogDeadline = "watchdog_deadline"
    case requestCancellation = "request_cancellation"
}

public struct MCPToolExecutionCancelledError: Error, Equatable, LocalizedError, Sendable {
    public init() {}
...
public enum MCPToolExecutionWatchdogEvent: Equatable, Sendable {
...
public enum MCPToolExecutionWatchdogError: Error, Equatable, Sendable {
    case executionTimedOut(settlement: MCPToolExecutionSettlement)
    case executionDetached
    case cleanupUnresponsive
}

public enum MCPToolExecutionWatchdogSchedulingPoint: Equatable, Sendable {
    case operationCompleted
    case deadlineExpired
    case cleanupGraceExpired
}

public struct MCPToolExecutionWatchdogEnvironment: Sendable {
    public let now: @Sendable () -> Duration
    public let sleep: @Sendable (Duration) async throws -> Void
    public let eventDidProduce: @Sendable (MCPToolExecutionWatchdogSchedulingPoint) async -> Void
    public let beforeEventConsumption: @Sendable (MCPToolExecutionWatchdogSchedulingPoint) async -> Void
    public let beforeCleanupGraceTaskRegistration: @Sendable () async -> Void
    public let beforeDetachActivation: @Sendable () -> Void
...
public enum MCPToolExecutionWatchdog {
