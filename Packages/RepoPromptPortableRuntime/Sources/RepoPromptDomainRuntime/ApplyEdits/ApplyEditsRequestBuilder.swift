...
public struct ApplyEditsRequestBuilder {
    public init() {}

    public func build(from args: [String: Value]) throws -> ApplyEditsRequest {
    ...
    public func buildFromNormalizedPayload(_ payload: [String: Value]) throws -> ApplyEditsRequest {
...
private enum ApplyEditsEchoGuard {
    ...
    public static func validate(replacement: String, path: String) throws {
