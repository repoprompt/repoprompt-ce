...
public enum DomainAgentRunCancellationIntent: Equatable, Hashable, Sendable {
...
public enum DomainAgentRunCancellationCompletion: Equatable, Hashable, Sendable {
...
public enum DomainAgentRunAttachmentTurnDisposition: Equatable, Hashable, Sendable {
...
public struct DomainAgentRunTerminalOutcome: Equatable, Hashable, Sendable {
    ...
    public let failureReason: DomainAgentRunSnapshot.FailureReason?
    ...
    public static func completed(assistantText: String?) -> DomainAgentRunTerminalOutcome {
    ...
    public var snapshotStatus: DomainAgentRunSnapshot.Status {
        switch kind {
