...
public struct DomainAgentRunSnapshot: Equatable, Sendable {
    ...
    public struct HookGate: Equatable, Sendable {
        ...
        public let approvedHookCount: Int
        public let skippedHookCount: Int?
        public let resolvedAt: Date

        public init(status: Status, approvedHookCount: Int, skippedHookCount: Int?, resolvedAt: Date) {
            self.status = status
