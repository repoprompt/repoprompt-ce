...
private struct IndentCache {
    ...
    public let indentLevels: [Int]
    public let trimmedLines: [String]

    public let indentType: String
...
public class IndentCorrectionUtility {
     ...
     */
    public static func reIndentUsingSearchBlock(
        oldBlock: [String],
        searchBlock: [String],
        newSnippet: [String],
    ...
    public static func shouldLogIndentDebug() -> Bool {
        false
    }
}
