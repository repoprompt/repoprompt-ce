...
public enum DiffGenerationError: Error {
    case emptyContent
...
public class DiffGenerationUtility {
    ...
    public static func generateRewriteDiff(fileContent: [String], newContent: [String]) -> [DiffChunk] {
    ...
    public static func generateDiffWithSearchBlock(
        fileContent: [String],
        searchBlock: [String],
        newContent: [String],
        diffPrecision: DiffPrecision = .normal,
    ...
    public static func findBestMatchUsingNGrams(
        selector: [LineData],
        in content: [LineData],
        lineIndexMap: [String: [Int]],
        mcpAmbiguityCheck: Bool = false,
    ...
    @inline(__always)
    public static func collapseSeparatorRuns(_ s: String) -> String {
        let pattern = #"[-_–—─━═]{2,}"#
    ...
    public static func processLine(
        _ raw: String,
    ...
    public static func buildLineIndexMapHigh(content: [LineData]) -> [String: [Int]] {
        var map: [String: [Int]] = [:]
    ...
    public static func matchSelectorFast(
        selector: [LineData],
        content: [LineData],
    ...
    public static func matchSelectorFastWithAmbiguityCheck(
        selector: [LineData],
        content: [LineData],
        lineIndex: [String: [Int]],
        maxFuzzyKeys maxKeys: Int = 400,
