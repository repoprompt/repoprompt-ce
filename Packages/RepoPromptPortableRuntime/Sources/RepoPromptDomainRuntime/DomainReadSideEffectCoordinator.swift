...
public enum DomainReadSideEffectError: Error, Equatable, Sendable {
...
public enum DomainReadSideEffectClass: String, Hashable, Sendable {
    case selection
    case gitArtifacts
}

public struct DomainReadSideEffectReceipt: Equatable, Sendable {
    public let operationID: UUID
    public let context: DomainContextIdentity
    public let effectClass: DomainReadSideEffectClass
...
public actor DomainReadSideEffectCoordinator {
