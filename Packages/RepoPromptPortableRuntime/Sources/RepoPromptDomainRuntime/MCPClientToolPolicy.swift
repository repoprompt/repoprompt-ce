...
public enum MCPClientTaskRole: String, CaseIterable, Sendable {
    case direct
    case explore
    case engineer
}

public enum MCPClientToolAnnotationProfile: String, CaseIterable, Sendable {
    case canonical
    case suppressReadOnlyHint = "suppress_read_only_hint"
}

public enum MCPClientToolPolicyProfile: String, CaseIterable, Sendable {
    case direct
    case discovery
...
public struct MCPClientToolPolicyClassification: Sendable {
    public let profile: MCPClientToolPolicyProfile
    public let restrictedCapabilities: Set<MCPToolCapability>
    public let grantedCapabilities: Set<MCPToolCapability>
    public let role: MCPClientTaskRole
    public let allowsAgentExternalControlTools: Bool
    public let annotationProfile: MCPClientToolAnnotationProfile
}

public enum MCPClientToolPolicyCatalog {
    public static let discoveryRestrictedCapabilities: Set<MCPToolCapability> = [
        .conversationSend,
    ...
    public static let discoveryGrantedCapabilities: Set<MCPToolCapability> = [
        .userInteraction,
    ]

    public static let agentModeRestrictedCapabilities: Set<MCPToolCapability> = [
        .workspaceMutate,
        .conversationHelper,
        .conversationSend,
    ]

    public static let agentModeGenericGrantedCapabilities: Set<MCPToolCapability> = [
        .userInteraction,
        .agentReasoningControl,
        .statusPublication,
        .agentConversationSend,
    ...
    public static let agentModeNativeGrantedCapabilities: Set<MCPToolCapability> = [
        .userInteraction,
        .statusPublication,
        .agentConversationSend,
        .conversationLog,
    ...
    public static let policyGatedCapabilities: Set<MCPToolCapability> = [
        .userInteraction,
        .agentReasoningControl,
        .statusPublication,
        .agentConversationSend,
    ...
    public static let classifications: [MCPClientToolPolicyProfile: MCPClientToolPolicyClassification] = [
        .direct: .init(
            profile: .direct,
    ...
    public static let policyGatedToolNames = MCPDomainToolCatalog.toolNames(for: policyGatedCapabilities)
    ...
    public static func hiddenToolNames(for role: MCPClientTaskRole) -> Set<String> {
    ...
    public static func resolvedToolNames(
        for profile: MCPClientToolPolicyProfile
    ) -> [String] {
