...
public enum DomainStandaloneScopeError: Error, Equatable, Sendable {
...
public struct DomainStandaloneBindingCASResult: Sendable {
    public let disposition: DomainRoutingDisposition
    public let snapshot: DomainStandaloneScopeSnapshot
...
public actor DomainStandaloneScopeCoordinator {
    ...
    public func snapshot(scopeID: DomainStandaloneScopeID) async throws -> DomainStandaloneScopeSnapshot {
    ...
    public func compareAndSetBinding(
        scopeID: DomainStandaloneScopeID,
    ...
    public func unregister(scopeID: DomainStandaloneScopeID) async {
