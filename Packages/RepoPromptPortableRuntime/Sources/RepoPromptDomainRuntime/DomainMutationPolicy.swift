...
public struct DomainHeadlessMutationGrant: Codable, Hashable, Identifiable, Sendable {
    public let id: UUID
    public let principalKey: String
    public let allowedOperations: Set<String>
    public let workspaceIDs: Set<UUID>
    ...
    public func revoking(at date: Date) -> Self {
        Self(
            id: id,
...
public struct DomainMutationPolicyDocument: Codable, Hashable, Sendable {
    ...
    public let revision: UInt64
    public let headlessGrants: [DomainHeadlessMutationGrant]
...
public enum DomainMutationPolicyHealth: Hashable, Sendable {
    case ready
    case degradedReadOnly(reason: String)
}

public struct DomainMutationAuthorizationSnapshot: Hashable, Sendable {
...
public enum DomainMutationPolicyError: Error, Equatable, LocalizedError, Sendable {
...
public actor DomainMutationPolicyStore {
    ...
    public func snapshot() async -> (DomainMutationPolicyDocument, DomainMutationPolicyHealth) {
