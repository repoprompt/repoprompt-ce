...
public enum MCPToolArgsNormalizer {
    ...
    public static func repairMalformedReplacement(in args: [String: Value]) -> (repaired: [String: Value], didRepair: Bool) {
