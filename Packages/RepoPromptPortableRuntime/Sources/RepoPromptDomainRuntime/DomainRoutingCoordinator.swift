...
public struct DomainWindowDescriptor: Codable, Equatable, Sendable {
...
public struct DomainConnectionRegistration: Codable, Hashable, Sendable {
    public let connectionID: UUID
    public let generation: UInt64
    public let runtimeID: UUID

    public init(connectionID: UUID, generation: UInt64, runtimeID: UUID) {
...
public enum DomainBinding: Codable, Equatable, Sendable {
    case unbound
...
public extension DomainBinding {
...
public struct DomainConnectionBindingSnapshot: Codable, Equatable, Sendable {
    public let registration: DomainConnectionRegistration
    public let binding: DomainBinding
}

public struct DomainRoutingSnapshot: Codable, Equatable, Sendable {
    public let runtimeID: UUID
    public let revision: UInt64
    public let windows: [DomainWindowDescriptor]
    public let connections: [DomainConnectionBindingSnapshot]
    public let pendingRunContexts: [UUID: DomainContextIdentity]
}

public enum DomainRoutingDisposition: String, Codable, Sendable {
    case applied
    case unchanged
    case conflict
    case rejected
...
public struct DomainRoutingOutcome: Codable, Equatable, Sendable {
    public let operationID: UUID
    public let disposition: DomainRoutingDisposition
    public let snapshot: DomainRoutingSnapshot
    public let diagnostic: String?
}

public struct DomainRunLaunchToken: Sendable {
    public let tokenID: UUID
    public let material: String
}

public struct DomainRunLaunchReservationRequest: Sendable {
    public let runID: UUID
    public let context: DomainContextIdentity
    public let expectedContextRevision: UInt64
    public let windowID: Int?
    public let clientPrincipal: String
    public let providerIdentifier: String
    public let runPurpose: String
    public let restrictedTools: Set<String>
    public let additionalTools: Set<String>
    public let expectedProcessID: Int32?
...
public struct DomainRunLaunchRedemption: Equatable, Sendable {
    public let binding: DomainConnectionBindingSnapshot
    public let restrictedTools: Set<String>
    public let additionalTools: Set<String>
...
public enum DomainRunLaunchRedemptionResult: Equatable, Sendable {
...
public enum DomainRunLaunchTokenError: Error, Equatable {
    case runtimeStopped
...
public actor DomainRoutingCoordinator {
    ...
    public func snapshot() -> DomainRoutingSnapshot {
    ...
    public func currentRegistration(connectionID: UUID) throws -> DomainConnectionRegistration {
    ...
    public func resolveReadContext(
    ...
    public func refreshReadContext(
    ...
    public func registerConnection(connectionID: UUID, operationID: UUID) -> DomainRoutingOutcome {
        guard !isStopped else { return stoppedOutcome(operationID) }
        if let prior = routingOperations[operationID] { return prior }
    ...
    public func unregisterConnection(
    ...
    public func revokeLaunchToken(_ tokenID: UUID) {
