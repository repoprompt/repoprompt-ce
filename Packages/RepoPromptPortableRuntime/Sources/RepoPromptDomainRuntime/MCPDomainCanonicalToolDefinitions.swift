...
public enum MCPDomainCanonicalToolDefinitions {
    public static let definitions: [MCPDomainToolDefinition] = decodeDefinitions()
    ...
    public static func reviewSnapshotData() throws -> Data {
